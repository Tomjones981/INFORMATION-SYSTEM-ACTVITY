...
function insertNewRecord(data){
    ...
    var cell6 = newRow.insertCell(5);
        ...
        cell6.innerHTML = data.schoolyear;
...
function onEdit(td){
    ...
    document.getElementById('schoolyear').value = selectedRow.cells[5].innerHTML;
...
function updateRecord(formData){
    ...
    selectedRow.cells[5].innerHTML = formData.schoolyear;
